...
export class AuthRuleAddDto {
  ...
  @IsEnum(['tab', 'link', 'iframe'], {
    message: 'menu_type 必须是 tab,link,iframe 之一',
  })
  menu_type: string;
  ...
  @ValidateIf((o) => o.menu_type === 'tab')
  @IsEnum(['none', 'add_rules_only', 'add_menu_only'], {
    message: 'extend 必须是 none,add_rules_only,add_menu_only',
  })
  extend: string;
